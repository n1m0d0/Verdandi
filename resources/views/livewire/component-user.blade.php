    ...
    <x-template-form>
        ...
        <x-slot name='form'>
            <div class="p-2">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" name="floating_email" wire:model="email"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="password" name="floating_password" wire:model="password"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        ...
                                        @if (Auth::user()->id != $user->id)
                                            ...
                                            <a href="{{ route('page.assignment', $user->id) }}"
                                                class="font-medium text-green-600 dark:text-green-500 hover:underline cursor-pointer pl-2">{{ __('Assignment') }}</a>
                                        @endif
                                    </td>
                                </tr>
                            @endif
