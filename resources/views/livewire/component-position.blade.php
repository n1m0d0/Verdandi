<div>
    <x-template-form>
            ...
            <div class="p-2">
                <div class="relative z-0 w-full mb-6 group">
                    <label for="first_name"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $entity_name }}</label>
                </div>
                <div class="relative z-0 w-full mb-6 group">
                        ...
                        @foreach ($positions as $position)
                            <tr
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <a wire:click='modalDelete({{ $position->id }})'
        ...
        <x-slot name='paginate'>
            {{ $positions->links('vendor.livewire.custom') }}
        </x-slot>
    </x-template-form>
